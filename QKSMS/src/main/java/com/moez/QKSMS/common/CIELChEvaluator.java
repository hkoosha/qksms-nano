 ...
 */
public final class CIELChEvaluator implements TypeEvaluator<Integer> {
    ...
    public CIELChEvaluator(final int startColor, final int endColor) {
    ...
    @Override
    public Integer evaluate(final float fraction, final Integer ignored, final Integer ignored2) {
    ...
    private final static class ColorCIELCh {

        final double L, C, H;

        ColorCIELCh(double l, double C, double H) {
            L = l;
            this.C = C;
            this.H = H;
        }
