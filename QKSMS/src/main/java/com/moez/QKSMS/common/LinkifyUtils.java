...
public class LinkifyUtils {
    ...
    private static Pattern bitcoin = Pattern.compile(
    ...
    private static TransformFilter returnMatchFilter = (match, url) -> match.group(1);
    ...
    private static <A extends CharacterStyle, B extends CharacterStyle> Spannable replaceAll(
    ...
    private static class NewTaskUrlSpan extends ClickableSpan {
        ...
        public void onClick(View widget) {
            try {
                ...
                Log.e("LinkifyUtils",
                      "",
                      ignored); // We should (or shouldn't) explain that no app can handle this intent ?
            }
        }
    }
